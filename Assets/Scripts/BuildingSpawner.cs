...
public class BuildingSpawner : MonoBehaviour
{
    ...
    private Vector3 _currentLeftBuildingLocation = new Vector3(-7.5f, 0, 0);
    private Vector3 _currentRightBuildingLocation = new Vector3(7.5f, 0, 0);
    ...
    void Start()
    {
        Debug.Log(_startingBuilding.transform.rotation);
